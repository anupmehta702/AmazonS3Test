...
import static com.anup.FileConstants.FILE_NAME;
...
public class BucketOperation {
    ...
    private static void downloadObject() throws FileNotFoundException {
        try {
            S3Object s3Object = s3.getObject(BUCKET_NAME, FILE_NAME);
            S3ObjectInputStream s3is = s3Object.getObjectContent();
            FileOutputStream fileToWrite = new FileOutputStream(new File("CustomerFromS3.csv"));
